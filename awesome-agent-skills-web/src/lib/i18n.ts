...
const commonEn: Copy = {
  ...
  roles: {
    ...
    allRoles: "All roles",
    curatedSkills: "recommended picks",
  ...
  skills: {
    ...
    trustCurated: "Reviewed pick",
    trustUntrusted: "Use with care",
    enterpriseOnly: "Popular with larger teams",
    excludeMarketplace: "Hide marketplace items",
  },
  common: {
    open: "Open",
    browse: "Browse",
    ...
    curatedSkills: "starter skills",
    broaderMatches: "more options",
    officialEnterprisePicks: "Start with trusted team picks",
  },
  roleLabels: {
...
const commonZh: Copy = {
  ...
  skills: {
    ...
    enterpriseOnly: "更适合大团队",
    excludeMarketplace: "隐藏 marketplace 项",
  },
  common: {
    open: "打开",
    browse: "浏览",
    ...
    curatedSkills: "个 starter skill",
    broaderMatches: "个更多选项",
    officialEnterprisePicks: "先看更靠谱的团队推荐",
  },
  roleLabels: {
    "data-analyst": "数据分析师",
    engineer: "工程师",
